...
// clientX/clientY) and bolt on the pointerId the hook reads. Not the DOM's
// `PointerEventInit` — just the fields this fake copies across.
...
describe("useLongPress", () => {
  ...
  const renderLongPress = (
    options: Omit<UseLongPressOptions, "domElementRef">,
  ) => {
